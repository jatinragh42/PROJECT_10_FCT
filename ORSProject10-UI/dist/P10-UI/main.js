...
var OrderComponent = /** @class */ (function (_super) {
    ...
    OrderComponent.prototype.validatePhone = function (event) {
        var input = event.key;
        // Check if the input is a number or backspace
        if ((isNaN(Number(input)) && input !== 'Backspace') || (input === ' ')) {
            event.preventDefault();
...
module.exports = __webpack_require__(/*! C:\Users\HP\Desktop\PROJECT_10_FCT\proect10_FrontCtl\ORSProject10-UI\src\main.ts */"./src/main.ts");
